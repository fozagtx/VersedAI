...
export default function TrackPage() {
    ...
    return (
      <>
        ...
        <div className="page-container py-24 text-center">
          ...
          <Link href="/tracks"><button className="btn-primary mt-4">Back to Tracks</button></Link>
        </div>
      </>
    );
  }
  ...
  return (
    <div style={{ background: "var(--background)" }}>
      ...
      <SidebarProvider>
        <AppSidebar activeTrackSlug={slug} />

        <SidebarInset>
          <header className="flex items-center gap-2 px-6 py-3 border-b" style={{ borderColor: "var(--border)" }}>
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm" style={{ color: "var(--muted-foreground)" }}>
              ...
              <span style={{ color: "var(--foreground)" }}>{track.title}</span>
            </nav>
          </header>

          <main id="main-content" className="px-6 md:px-10 py-10 max-w-3xl">
            {/* Level badge + title */}
            <motion.div
            ...
            {trackDone && (
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-sm">Track Complete!</p>
                  <p className="text-xs opacity-80">+{track.totalXp} XP earned</p>
                </div>
              </div>
            )}
